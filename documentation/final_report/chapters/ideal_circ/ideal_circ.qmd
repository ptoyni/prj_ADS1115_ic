...
First of all, let's see conceptually simplest Sample and Hold **(S/H)** consists of a Switch and Capacitor in @fig-SIMPLE_SH.
...
Taking a closure look, Resistance is much suspectable to thermal noise and is modelled as voltage $\vn $ in series with resistance. Ouput Noise is present for all frequencies also known as **Whilte Noise** and is given as 

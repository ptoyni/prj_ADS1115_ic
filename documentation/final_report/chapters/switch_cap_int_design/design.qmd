...
![Implementation of Telescopic OTA](figures/opamp/Telescopic.svg)
![AC analysis of Telescopic OTA](figures/opamp/ac0.svg)
![AC analysis of Telescopic OTA](figures/opamp/ac1.svg)
![Transient Response of Telescopic OTA](figures/opamp/tran0.svg)

Its giving us DC Gain of 9.6059e-01, Gain error of -3.9408e-02 and Slew rate (tsettle) of 7.0329e-07 at $I_0$ equivalent to 0.8microA.Below is the Switch Capacitor circuit with phase 1 and 2.

![Implementation of Switch Capacitor](figures/opamp/Final_circuit_last.svg)
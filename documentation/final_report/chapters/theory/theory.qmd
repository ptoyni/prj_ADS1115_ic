...
The remaining term, describing a delayed integrator, is what will be utilized in the MATLAb assited system analysis. That ultimately leads to the following description of out feedback system.

![System Overview of the 1st order loopfilter](figures/theory/Simple_1stOrder_Mod_sys.png){#loopfilter_sys_1st_order}

# Extended Behaviour Description

We shall also briefly elaborate on the circuit extentions that occure in the case ofthe desired 2nd order casdade structure of the modulator, also including the feedback aspect

...
print("ADS1115: Measurements from chosen input channnel via Continuous Mode")
...
while t < 40:     
    ...
    print("Signal Level: {:<8.3f}V".format(voltage3))#, voltage0, voltage1, voltage2))
    sleep_ms(10)
    t = t+1

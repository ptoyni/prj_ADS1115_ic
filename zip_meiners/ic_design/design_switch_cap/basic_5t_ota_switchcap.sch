...
N -480 30 -480 70 {lab=#net3}
N -480 -210 -480 -170 {lab=ibias}
N -420 -90 -330 -90 {lab=ibias}
...
N -660 -400 -290 -400 {lab=vdd}
N -290 -90 -190 -90 {lab=vss}
...
N -590 -90 -480 -90 {lab=vss}
N -590 -90 -590 100 {lab=vss}
N -190 -120 -190 -90 {lab=vss}
N -480 -170 -420 -170 {lab=ibias}
N -420 -170 -420 -90 {lab=ibias}
N -440 -90 -420 -90 {lab=ibias}
N -420 30 -420 100 {lab=#net3}
N -440 100 -420 100 {lab=#net3}
N -480 30 -420 30 {lab=#net3}
...
C {sg13g2_pr/sg13_lv_nmos.sym} -310 -90 0 0 {name=M9
l=2u
w=0.15u
ng=1
m=1
...
C {sg13g2_pr/sg13_lv_nmos.sym} -460 -90 0 1 {name=M8
l=2u
w=0.15u
ng=1
m=1

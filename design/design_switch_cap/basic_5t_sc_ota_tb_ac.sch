...
N -700 -530 -250 -530 {lab=v_ss}
N -300 -790 -250 -790 {lab=v_out}
N -250 -790 -250 -750 {lab=v_out}
N -250 -690 -250 -530 {lab=v_ss}
N -860 -810 -860 -780 {lab=#net1}
N -860 -780 -660 -780 {lab=#net1}
N -660 -780 -660 -770 {lab=#net1}
N -860 -890 -670 -890 {lab=v_dd}
N -670 -890 -660 -790 {lab=v_dd}
N -1070 -770 -840 -770 {lab=v_in}
N -840 -770 -840 -730 {lab=v_in}
N -840 -730 -660 -730 {lab=v_in}
N -710 -710 -660 -710 {lab=v_ss}
N -710 -710 -700 -530 {lab=v_ss}
N -1070 -530 -700 -530 {lab=v_ss}
N -740 -750 -660 -750 {lab=v_out}
N -740 -750 -740 -640 {lab=v_out}
N -740 -640 -290 -640 {lab=v_out}
N -300 -790 -290 -640 {lab=v_out}
N -360 -790 -300 -790 {lab=v_out}
...
"}
C {devices/vsource.sym} -1150 -460 0 0 {name=Vdd value=1.5}
...
C {capa.sym} -250 -720 0 0 {name=C1
value=0.47p}
C {lab_wire.sym} -250 -790 0 1 {name=p3 sig_type=std_logic lab=v_out}
...
C {isource.sym} -860 -840 0 0 {name=I0 value=0.8u}
C {spice_probe.sym} -950 -770 0 0 {name=p5 attrs=""}
C {spice_probe.sym} -340 -790 0 0 {name=p6 attrs=""}
C {basic_5t_ota_switchcap.sym} -510 -750 0 0 {name=x1}
